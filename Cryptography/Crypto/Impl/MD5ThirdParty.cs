...
namespace Cryptography
{
    ...
    /// MD5算法的第三方实现
    /// </summary>
    public class MD5ThirdParty:IEncryptable
    {
        ...
        private static string CalcMD5(string str)
        {
            ...
            var md5 = new MD5ThirdParty();
            return md5.CalcMD5(data);
        }
        ...
        private sealed class Digest
        {
            ...
            {
                string str = 
                    BitHelper.ReverseByte(A).ToString("X8") +
        ...
        /// Calculate MD5 Hash
        /// </summary>
        private string CalcMD5(byte[] bytes)
        {
            var dg = new Digest();
